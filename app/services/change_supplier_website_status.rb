class ChangeSupplierWebsiteStatus < SupplierContactPointCommand
  def call
    prepare!
    raise Error.new("Choose active or inactive.", code: :invalid) unless SupplierWebsite::STATUSES.include?(@status)
    ...
    ActiveRecord::Base.transaction do
      ...
      audit_contact!(supplier, record: point, changed_fields: [ "website_status" ])
