class DeactivatePartyContactPoint < DirectoryCommand
  ...
  def perform
    ...
    return CommandResult.new(status: :accepted, party: @party, contact_point: @contact_point) if @contact_point.deactivated?
    ...
    audit!(
      agency: @agency,
      action: "directory.contact_deactivated",
