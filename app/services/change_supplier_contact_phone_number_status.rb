class ChangeSupplierContactPhoneNumberStatus < SupplierContactDestinationCommand
  def call
    prepare!
    raise Error.new("Choose active or inactive.", code: :invalid) unless SupplierContactPhoneNumber::STATUSES.include?(@status)
    ...
    ActiveRecord::Base.transaction do
      ...
      audit_contact!(contact, record: point, changed_fields: [ "phone_number_status" ])
