class ChangeClientPersonEmailAddressStatus < ClientPersonContactPointCommand
  def call
    prepare!
    raise Error.new("Choose active or inactive.", code: :invalid) unless ClientPersonEmailAddress::STATUSES.include?(@status)
    ...
    ActiveRecord::Base.transaction do
      ...
      audit_contact!(person, changed_fields: [ "email_address_status" ])
