...
class UpdatePackagePriceDefinition < AgencyCommand
  ...
  def call
    ...
    ActiveRecord::Base.transaction do
      ...
      raise Error.new("That package has no price to update.", code: :invalid_state) if definition.nil?

      currency = require_operating_currency!(departure)
      mode = @attributes[:mode].to_s.presence || definition.mode
      ...
      audit!(
        agency: @agency, action: "package.price_updated", subject: package, actor: @actor,
