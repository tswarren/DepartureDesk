class ChangeClientPersonPhoneNumberStatus < ClientPersonContactPointCommand
  def call
    prepare!
    raise Error.new("Choose active or inactive.", code: :invalid) unless ClientPersonPhoneNumber::STATUSES.include?(@status)
    ...
    ActiveRecord::Base.transaction do
      ...
      audit_contact!(person, changed_fields: [ "phone_number_status" ])
