class RecordAdministrativeAudit
  ...
  def ensure_subject_belongs_to_agency!(agency, subject)
    ...
    when Party, Person, Household, Organization, PartyAlternateName, PartyContactPoint, ContactPointPurposeAssignment, PartyRelationship, RelationshipPurposeAssignment, PartyNote, ClientProfile, SupplierProfile, ClientAdvisorAssignment, SupplierServiceCategoryAssignment, ExternalIdentifier, TravelProgram, Departure, SupplierArrangement, SupplierReservation, SupplierResource, SupplierServiceOccurrence, SupplierConfirmation, SupplierCostTerm, SupplierCommitment, SupplierDepositRequirement, SupplierClause, SupplierDeadline, SupplierCapacityPosition
      return if subject.agency_id == agency.id
