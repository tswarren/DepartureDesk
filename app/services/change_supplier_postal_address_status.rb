class ChangeSupplierPostalAddressStatus < SupplierContactPointCommand
  def call
    prepare!
    raise Error.new("Choose active or inactive.", code: :invalid) unless SupplierPostalAddress::STATUSES.include?(@status)
    ...
    ActiveRecord::Base.transaction do
      ...
      audit_contact!(supplier, record: point, changed_fields: [ "postal_address_status" ])
