class ChangeSupplierPhoneNumberStatus < SupplierContactPointCommand
  def call
    prepare!
    raise Error.new("Choose active or inactive.", code: :invalid) unless SupplierPhoneNumber::STATUSES.include?(@status)
    ...
    ActiveRecord::Base.transaction do
      ...
      audit_contact!(supplier, record: point, changed_fields: [ "phone_number_status" ])
