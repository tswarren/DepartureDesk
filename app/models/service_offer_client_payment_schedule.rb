...
class ServiceOfferClientPaymentSchedule < ApplicationRecord
  ...
  has_many :lines, class_name: "ServiceOfferClientPaymentScheduleLine", dependent: :restrict_with_exception
