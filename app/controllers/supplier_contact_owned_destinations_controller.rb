class SupplierContactOwnedDestinationsController < ApplicationController
  ...
  before_action :set_supplier_contact
  ...
  def create
    ...
    redirect_to supplier_contact_path(@supplier, @supplier_contact), notice: "#{channel_label} saved."
  ...
  def update
    ...
    redirect_to supplier_contact_path(@supplier, @supplier_contact), notice: "#{channel_label} updated."
  rescue AgencyCommand::DuplicateReviewRequired => error
  ...
  def set_primary
    ...
    redirect_to supplier_contact_path(@supplier, @supplier_contact), notice: notice
  rescue AgencyCommand::Error => error
    redirect_to supplier_contact_path(@supplier, @supplier_contact), alert: error.message
  end
  ...
  def update_status
    ...
    redirect_to supplier_contact_path(@supplier, @supplier_contact), notice: "#{channel_label} status updated."
  rescue AgencyCommand::Error => error
