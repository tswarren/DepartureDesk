class ClientPersonContactPointsController < ApplicationController
  include DirectoryAccess

  before_action :require_directory_management!
  before_action :set_client_person
  ...
  def create
    ...
    redirect_to client_person_path(@client_person), notice: "#{channel_label} saved."
  ...
  def update
    ...
    redirect_to client_person_path(@client_person), notice: "#{channel_label} updated."
  rescue AgencyCommand::DuplicateReviewRequired => error
  ...
  def update_status
    ...
    redirect_to client_person_path(@client_person), notice: "#{channel_label} status updated."
  rescue AgencyCommand::Error => error
