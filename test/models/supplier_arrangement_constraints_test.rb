...
class SupplierArrangementConstraintsTest < ActiveSupport::TestCase
  ...
  test "catalogs include M3A permissions audit actions and subject ownership" do
    ...
    AuditEvent::ACTIONS.grep(/\Asupplier_arrangement\./).then do |actions|
      ...
      assert_includes actions, "supplier_arrangement.typed_item_setup"
      ...
      assert_includes actions, "supplier_arrangement.deposit_definition_created"
      assert_includes actions, "supplier_arrangement.deposit_definition_updated"
      assert_includes actions, "supplier_arrangement.deposit_definition_removed"
      assert_includes actions, "supplier_arrangement.deposits_materialized"
      assert_includes actions, "supplier_arrangement.deposit_attested_external"
      assert_includes actions, "supplier_arrangement.planning_milestone_recorded"
      assert_includes actions, "supplier_arrangement.exposure_qualified"
    end
