...
- [ADR 0013: Supplier operational commitments, Deadlines, exposure, and Arrangement ending](docs/adr/0013-supplier-operational-commitments-deadlines-exposure-and-ending.md) accepts source-shaped commitment openings and dispositions, Deposit Requirements, Deadlines, planning milestones, exposure, Needs attention, and Arrangement ending. [M3E](docs/planning/m3e-supplier-operational-control.md) is the Accepted implementing slice; M3E.1–M3E.2 are shipped, later M3E records remain unimplemented.
