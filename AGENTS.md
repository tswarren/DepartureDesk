...
- [ADR 0008: Supplier Arrangement version topology](docs/adr/0008-supplier-arrangement-version-topology.md) accepts stable Arrangement and child identities with per-version definitions. M3A draft topology is implemented; activation and successor behavior remain Accepted M3D work after shipped M3D.0.
...
- [ADR 0010: Supplier capacity ledger and projection](docs/adr/0010-supplier-capacity-ledger-and-projection.md) accepts stable Capacity Pool identity, immutable capacity events, scheduled effectiveness, reconciliation, and rebuildable projections. [M3B](docs/planning/m3b-supplier-capacity.md) shipped the implementing persistence and engine; Arrangement activation and Staff event UI remain Accepted M3D work after shipped M3D.0.
- [ADR 0011: Supplier cost definitions and forecast evaluation](docs/adr/0011-supplier-cost-definitions-and-forecast-evaluation.md) accepts exact-version cost sources, staged definitions, constrained components, planning assumptions, and derived forecasts. [M3C](docs/planning/m3c-cost-terms-and-forecasts.md) shipped the implementing slice; Arrangement activation and effective contracted terms remain Accepted M3D work after shipped M3D.0.
- [ADR 0012: Arrangement activation, Reservations, and confirmations](docs/adr/0012-arrangement-activation-reservations-and-confirmations.md) accepts activation manifests, successor copying, Reservation history, confirmation evidence, and the M3D confirmation-triggered commitment core. [M3D](docs/planning/m3d-activation-reservations-confirmations.md) is the Accepted implementing slice and is not yet shipped; production implementation requires shipped [M3D.0](docs/planning/m3d0-planning-workspace-compression.md).
