...
The shipped domain is agency identity, the complete M1 Client and Supplier directories, [M2A](docs/planning/m2a-departure-core.md) Departure draft/activation/`D-` issuance/return to draft/search, [M2B](docs/planning/m2b-departed-lifecycle.md) departed transitions, scheduled lifecycle jobs, and schedule/currency/lifecycle corrections, [M2C](docs/planning/m2c-acceptance-and-hardening.md) proof and hardening, [M3A](docs/planning/m3a-draft-arrangement-structure.md) draft Supplier Arrangement structure, and [M3B](docs/planning/m3b-supplier-capacity.md) draft Supplier capacity configuration plus the capacity event/projection/reconciliation engine. M2 is complete. The [M3 parent](docs/planning/m3-supplier-planning.md) is accepted and amended for M3B and M3C and is not implementation authority for later slices. [M3C](docs/planning/m3c-cost-terms-and-forecasts.md) is Accepted implementation authority for cost terms and forecasts only and is not yet shipped. Arrangement activation and user-accessible effective capacity / event controls remain M3D work. Travel Program, Reservations, commitments, Deadlines, exposure, remittance, FX, and later M3 records remain unimplemented. Do not implement them until an accepted slice plan names that work.

Documentation authority and status are indexed in [docs/README.md](docs/README.md). Product authority is [docs/planning/departure-desk-mvp.md](docs/planning/departure-desk-mvp.md) and [docs/planning/commercial-domain-decision-register.md](docs/planning/commercial-domain-decision-register.md). Do not implement MFA, platform support, a workforce-role taxonomy, Travel Program, or later commercial records from those documents until an accepted slice plan names that work. An accepted milestone contract is not enough. [M1A](docs/planning/m1a-individual-client.md), [M1B](docs/planning/m1b-client-organizations.md), [M1C](docs/planning/m1c-supplier-core.md), [M1D](docs/planning/m1d-supplier-locations-and-contacts.md), [M1E](docs/planning/m1e-directory-acceptance-and-hardening.md), [M2A](docs/planning/m2a-departure-core.md), [M2B](docs/planning/m2b-departed-lifecycle.md), [M2C](docs/planning/m2c-acceptance-and-hardening.md), [M3A](docs/planning/m3a-draft-arrangement-structure.md), and [M3B](docs/planning/m3b-supplier-capacity.md) are shipped. [M3C](docs/planning/m3c-cost-terms-and-forecasts.md) is Accepted but not yet shipped. M2 is complete. Later M3 records remain unimplemented until accepted slice plans name that work. [docs/terminology.md](docs/terminology.md) is the current vocabulary; Party-era terminology is archived.
...
- [ADR 0008: Supplier Arrangement version topology](docs/adr/0008-supplier-arrangement-version-topology.md) accepts stable Arrangement and child identities with per-version definitions. M3A draft topology is implemented; activation and successor behavior are deferred.
