...
- [ADR 0010: Supplier capacity ledger and projection](docs/adr/0010-supplier-capacity-ledger-and-projection.md) accepts stable Capacity Pool identity, immutable capacity events, scheduled effectiveness, reconciliation, and rebuildable projections. It is not implementation authority by itself; [M3B](docs/planning/m3b-supplier-capacity.md) is the implementing slice.
