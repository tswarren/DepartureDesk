...
| [0014](0014-client-offers-publication-and-supply-compatibility.md) | Accepted. M4A implements unpublished drafts and source compatibility; not implementation authority for later slices | Client Service Offer and Package identity, publication, Supplier-source compatibility, Sales enabled versus computed eligibility, and M5 Charge-posting handoff. [M4A](../planning/m4a-service-definitions-and-sources.md) is shipped. Do not implement M4B–M4E until that slice's accepted plan names the work. |
