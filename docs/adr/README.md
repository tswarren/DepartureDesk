...
| [0012](0012-arrangement-activation-reservations-and-confirmations.md) | Accepted; M3D is the implementing slice (Implemented—remediation pending; requires shipped M3D.0) | Arrangement activation manifests, successor copying, Reservation history, confirmation evidence, and confirmation-triggered commitment openings. |
