...
| [0013](0013-supplier-operational-commitments-deadlines-exposure-and-ending.md) | Accepted; M3E is the implementing slice (Accepted; not yet implemented) | Source-shaped commitment openings and dispositions, Deposit Requirements, Deadlines, planning milestones, exposure, Needs attention, and Arrangement ending. |
