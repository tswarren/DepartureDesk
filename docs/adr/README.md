...
| [0014](0014-client-offers-publication-and-supply-compatibility.md) | Accepted. M4A implements unpublished drafts and source compatibility; M4B implements unpublished Client prices and anonymous preview; not implementation authority for later slices | Client Service Offer and Package identity, publication, Supplier-source compatibility, Sales enabled versus computed eligibility, and M5 Charge-posting handoff. [M4A](../planning/m4a-service-definitions-and-sources.md) and [M4B](../planning/m4b-client-pricing-and-anonymous-preview.md) are shipped. Do not implement M4C–M4E until that slice's accepted plan names the work. |
