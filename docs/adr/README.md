...
| [0013](0013-supplier-operational-commitments-deadlines-exposure-and-ending.md) | Accepted; M3E implementing slice (M3E.1–M3E.2 shipped; later records unimplemented) | Source-shaped commitment openings and dispositions, Deposit Requirements, Deadlines, planning milestones, exposure, Needs attention, and Arrangement ending. |
