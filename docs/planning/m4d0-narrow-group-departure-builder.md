...
**Implementation base:** [`88db505`](https://github.com/tswarren/DepartureDesk/commit/88db505fa81ab740ad134fea28998841b401d7e9) (`88db505`), the [M4D merge](https://github.com/tswarren/DepartureDesk/pull/120) on `main`. Coding slices reconfirm required CI on the branch tip; use this commit or a later CI-green descendant that still includes shipped M4D.
