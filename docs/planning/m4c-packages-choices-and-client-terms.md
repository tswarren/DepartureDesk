...
**Authority:** Parent, ADR 0014, and M4.0 as above. [ADR 0001](../adr/0001-money-and-currency.md) governs money. Lock order inherits [M4A](m4a-service-definitions-and-sources.md). Later: [M4D](m4d-publication-and-live-feasibility.md) (shipped) · [M4E](drafts/DepartureDesk-M4E-acceptance-and-hardening-draft.md).
