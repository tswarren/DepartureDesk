...
| M3 — Supplier planning | Planned | Represent arrangements, items, occurrences, resources, commitments, capacity, deadlines, and exposure. The [parent](m3-supplier-planning.md) is accepted and amended through M3D authority. [M3A](m3a-draft-arrangement-structure.md), [M3B](m3b-supplier-capacity.md), and [M3C](m3c-cost-terms-and-forecasts.md) are shipped. [M3D.0](m3d0-planning-workspace-compression.md) and [M3D](m3d-activation-reservations-confirmations.md) are Accepted, not shipped; their prerequisite boundary controls implementation. |
...
3. [M3A](m3a-draft-arrangement-structure.md), [M3B](m3b-supplier-capacity.md), and [M3C](m3c-cost-terms-and-forecasts.md) are shipped. The [M3 parent](m3-supplier-planning.md) remains accepted and is not implementation authority by itself for later slices. [ADR 0008](../adr/0008-supplier-arrangement-version-topology.md), [ADR 0009](../adr/0009-supplier-contracting-and-service-provider-roles.md), [ADR 0010](../adr/0010-supplier-capacity-ledger-and-projection.md), and [ADR 0011](../adr/0011-supplier-cost-definitions-and-forecast-evaluation.md) remain accepted architecture. Travel Program, Arrangement activation, user-accessible effective capacity or event UI, Reservations, commitments, Deadlines, exposure, remittance, FX, and later M3 records remain unimplemented. Production activation and every other M3D domain workflow remain prohibited until the accepted prerequisite sequence below is satisfied.
4. Accepted [M3D.0](m3d0-planning-workspace-compression.md) authorizes implementation of bounded M3A–M3C workflow remediation only. Arrangement activation, Reservations, confirmations, commitments, effective-capacity event controls, and every other M3D domain record remain blocked while M3D.0 is unshipped.
5. Accepted [M3D](m3d-activation-reservations-confirmations.md) and accepted [ADR 0012](../adr/0012-arrangement-activation-reservations-and-confirmations.md) authorize their Arrangement activation, Reservation, and effective-capacity scope only after M3D.0 ships. There is no waiver path.
