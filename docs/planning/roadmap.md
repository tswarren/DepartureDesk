...
| M4 — Offers and pricing | Parent accepted; M4A–M4C shipped; M4D Accepted | Describe Packages and standalone services the Agency intends to sell. The [parent](m4-offers-and-pricing.md), [ADR 0014](../adr/0014-client-offers-publication-and-supply-compatibility.md), and [M4.0](m40-task-flow-and-contract.md) are accepted and are not implementation authority for later slices. [M4A](m4a-service-definitions-and-sources.md), [M4B](m4b-client-pricing-and-anonymous-preview.md), and [M4C](m4c-packages-choices-and-client-terms.md) are shipped. [M4D](m4d-publication-and-live-feasibility.md) is Accepted and not shipped. M4E remains unimplemented. |
