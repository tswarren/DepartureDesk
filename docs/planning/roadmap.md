...
| M4 — Offers and pricing | Parent accepted; M4A–M4D.0 + M4D.0R shipped; M4D.1 Accepted; Slice 1 Accepted unshipped | Describe Packages and standalone services the Agency intends to sell. The [parent](m4-offers-and-pricing.md), [ADR 0014](../adr/0014-client-offers-publication-and-supply-compatibility.md), and [M4.0](m40-task-flow-and-contract.md) are accepted and are not implementation authority for later slices. [M4A](m4a-service-definitions-and-sources.md), [M4B](m4b-client-pricing-and-anonymous-preview.md), [M4C](m4c-packages-choices-and-client-terms.md), and [M4D](m4d-publication-and-live-feasibility.md) are shipped. [M4D.0](m4d0-narrow-group-departure-builder.md) and interim [M4D.0R](m4d0r-builder-interface-remediation.md) are shipped. [M4D.1](m4d1-departure-composition-workspace.md) is Accepted (future composition workspace; not shipped). [M4D.1 Slice 1](m4d1-slice1-workspace-foundation.md) is Accepted unshipped foundation authority. M4E remains unimplemented. |
