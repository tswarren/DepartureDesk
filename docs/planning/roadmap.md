...
| M3 — Supplier planning | In progress | Represent arrangements, items, occurrences, resources, commitments, capacity, deadlines, and exposure. The [parent](m3-supplier-planning.md) is accepted and amended through M3E authority. [M3A](m3a-draft-arrangement-structure.md), [M3B](m3b-supplier-capacity.md), [M3C](m3c-cost-terms-and-forecasts.md), [M3D.0](m3d0-planning-workspace-compression.md), [M3D](m3d-activation-reservations-confirmations.md), [M3D.7](m3d7-activated-definition-immutability.md), [M3D.8](m3d8-activation-reservation-product-quality.md), and [M3D.9](m3d9-reservation-integrity.md) are shipped. [M3E](m3e-supplier-operational-control.md) is shipped through M3E.7b (including M3E.5R and M3D remediations). Arrangement ending is shipped. M3E is fully shipped. M3F remains. |
...
5. Travel Program, remittance, FX, and M3F remain unimplemented. Client demand, Travelers, Obligations, and Payments remain unimplemented. Celebrity deposits/milestones remain Arrangement-wide; `per_source` Deadlines remain deferred. See the [M3F supplier-planning task-flow backlog](m3-supplier-planning.md#m3f-supplier-planning-task-flow-backlog).
