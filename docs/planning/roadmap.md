...
3. The [M1B Client Organization slice plan](m1b-client-organizations.md) is implemented and merged. Client Organization, organization-backed Client, organization contact points, organization-contact history, and expanded Client search are shipped. Suppliers are not.
