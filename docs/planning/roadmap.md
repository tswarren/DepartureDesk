...
| M4 — Offers and pricing | Parent accepted; M4A shipped | Describe Packages and standalone services the Agency intends to sell. The [parent](m4-offers-and-pricing.md), [ADR 0014](../adr/0014-client-offers-publication-and-supply-compatibility.md), and [M4.0](m40-task-flow-and-contract.md) are accepted and are not implementation authority for later slices. [M4A](m4a-service-definitions-and-sources.md) is shipped. M4B–M4E remain unimplemented. |
...
6. [M4 parent](m4-offers-and-pricing.md), [ADR 0014](../adr/0014-client-offers-publication-and-supply-compatibility.md), and [M4.0](m40-task-flow-and-contract.md) are accepted and are not implementation authority for later slices. [M4A](m4a-service-definitions-and-sources.md) is shipped (unpublished Service Offer drafts and source compatibility). M4B is next and unimplemented. Travel Program, remittance, FX, Client demand, Travelers, Obligations, and Payments remain unimplemented. Celebrity deposits/milestones remain Arrangement-wide; `per_source` Deadlines remain deferred.
