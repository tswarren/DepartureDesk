...
| M3 — Supplier planning | In progress | Represent arrangements, items, occurrences, resources, commitments, capacity, deadlines, and exposure. The [parent](m3-supplier-planning.md) is accepted and amended through M3E authority. [M3A](m3a-draft-arrangement-structure.md), [M3B](m3b-supplier-capacity.md), [M3C](m3c-cost-terms-and-forecasts.md), [M3D.0](m3d0-planning-workspace-compression.md), [M3D](m3d-activation-reservations-confirmations.md), [M3D.7](m3d7-activated-definition-immutability.md), [M3D.8](m3d8-activation-reservation-product-quality.md), and [M3D.9](m3d9-reservation-integrity.md) are shipped. [M3E](m3e-supplier-operational-control.md) is Accepted; [M3E.0](m3e0-m3d-closure-gate.md) is satisfied; M3E domain work is not yet implemented. M3F remains. |
...
4. [M3D](m3d-activation-reservations-confirmations.md) is shipped under [ADR 0012](../adr/0012-arrangement-activation-reservations-and-confirmations.md). [M3E](m3e-supplier-operational-control.md) is Accepted under [ADR 0013](../adr/0013-supplier-operational-commitments-deadlines-exposure-and-ending.md); [M3E.0](m3e0-m3d-closure-gate.md) is satisfied. M3E domain work is not yet implemented.
5. Travel Program, remittance, FX, and M3F remain unimplemented. Accepted M3E records (Deadlines, exposure, Arrangement ending, dispositions) remain unimplemented until M3E code ships.
