...
4. Next is Accepted [M3D](m3d-activation-reservations-confirmations.md), governed by accepted [ADR 0012](../adr/0012-arrangement-activation-reservations-and-confirmations.md). Arrangement activation, Reservations, confirmations, commitments, effective-capacity event controls, and every other M3D domain record remain unimplemented until M3D ships.
