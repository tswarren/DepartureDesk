...
| M3 — Supplier planning | Planned | Represent arrangements, items, occurrences, resources, commitments, capacity, deadlines, and exposure. The [parent](m3-supplier-planning.md) is accepted and amended for M3B. [M3A](m3a-draft-arrangement-structure.md) is shipped. [M3B](m3b-supplier-capacity.md) is Accepted implementation authority for capacity only and is not yet shipped. Later M3 slices remain unimplemented until accepted. |
...
3. [M3A](m3a-draft-arrangement-structure.md) is shipped. [M3B](m3b-supplier-capacity.md) is Accepted and is the only slice that may implement Supplier capacity; capacity code is not yet shipped. The [M3 parent](m3-supplier-planning.md) remains accepted and is not implementation authority for later slices. [ADR 0008](../adr/0008-supplier-arrangement-version-topology.md), [ADR 0009](../adr/0009-supplier-contracting-and-service-provider-roles.md), and [ADR 0010](../adr/0010-supplier-capacity-ledger-and-projection.md) remain accepted architecture. Do not implement Travel Program, Arrangement activation, effective capacity UI, costs, Reservations, commitments, Deadlines, exposure, or later M3 slices until an accepted slice names that work.
