...
**Status:** Implementation guide only under shipped [M4D.1 Slice 2A.2R2](../m4d1-slice2a2r2-cruise-rate-matrix-interaction.md) (layout suggestions). Shipped compilation authority remains [M4D.1 Slice 2A.2R](../m4d1-slice2a2r-cruise-supplier-rate-matrix.md). Not competing product authority.
