...
- [Composition workspace](composition-workspace/README.md) (stubs → Accepted M4D.1 / shipped Slice 1 / shipped Slice 2A.1 / shipped Slice 2A.2 / Accepted Slice 2A.2R; proposed later slices discovery-only)
