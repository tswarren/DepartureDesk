...
- [Composition workspace](composition-workspace/README.md) (stubs → Accepted M4D.1 / shipped Slice 1 / shipped Slice 2A.1–2A.2R3 / shipped 2B-R; Draft 2B; proposed later slices discovery-only)
