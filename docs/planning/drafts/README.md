...
- [Composition workspace](composition-workspace/README.md) (stubs → Accepted M4D.1 / shipped Slice 1 / Accepted Slice 2A.1; proposed later slices discovery-only)
