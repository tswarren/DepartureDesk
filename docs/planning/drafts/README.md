...
- [Composition workspace](composition-workspace/README.md) (stubs → Accepted M4D.1 / shipped Slice 1 / shipped Slice 2A.1 / shipped Slice 2A.2 / shipped Slice 2A.2R / Accepted Slice 2A.2R2; proposed later slices discovery-only)
