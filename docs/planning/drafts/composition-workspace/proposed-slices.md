...
**Accepted, not shipped:** [Slice 2C — Cruise service connection](../../m4d1-slice2c-cruise-service-connection.md).
...
6. **Slice 2C — Service connection, categories, and Client choices** ([Accepted](../../m4d1-slice2c-cruise-service-connection.md); not shipped)
