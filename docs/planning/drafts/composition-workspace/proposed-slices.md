...
**Accepted typed slice:** [M4D.1 Slice 2A.2 — Cruise Supplier rates and occupancy totals](../../m4d1-slice2a2-cruise-supplier-rates-and-occupancy-totals.md) (**Accepted**, not yet shipped). That plan is the sole implementation authority for Stop point C.
...
Recommended refinement sequence after Accepted 2A.2:
