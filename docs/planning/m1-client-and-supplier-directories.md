...
**Decision posture:** Product review confirmed the recommended defaults, including the contract closures in this document, on 2026-09-14. [M1A](m1a-individual-client.md) and [M1B](m1b-client-organizations.md) are shipped and merged. [M1C](m1c-supplier-core.md) is Accepted (implementation not started). M1D–M1E remain deferred.
