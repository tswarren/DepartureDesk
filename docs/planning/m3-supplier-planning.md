...
**Status:** Accepted 2026-09-16. Amended 2026-09-16. Amended again 2026-09-16 for M3B capacity. Amended 2026-09-17 for M3C cost terms. Amended 2026-09-17 for M3D authority and M3D.0. [M3A](m3a-draft-arrangement-structure.md), [M3B](m3b-supplier-capacity.md), [M3C](m3c-cost-terms-and-forecasts.md), and [M3D.0](m3d0-planning-workspace-compression.md) are shipped. [M3D](m3d-activation-reservations-confirmations.md) is Implemented—remediation pending. [ADR 0012](../adr/0012-arrangement-activation-reservations-and-confirmations.md) is implemented by that M3D work. Later M3E–M3F slices remain unimplemented.
