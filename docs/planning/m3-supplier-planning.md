...
**Status:** Accepted 2026-09-16. Amended 2026-09-16. Amended again 2026-09-16 for M3B capacity. Amended 2026-09-17 for M3C cost terms. Amended 2026-09-17 for M3D authority and M3D.0. Amended 2026-09-18 for M3E authority. Amended 2026-09-20 for M3F.0 Accepted contract. **M3 complete 2026-09-20** after shipped [M3F](m3f-acceptance-and-hardening.md) through [M3F.4](m3f4-milestone-closure.md). [M3A](m3a-draft-arrangement-structure.md)–[M3E](m3e-supplier-operational-control.md) and M3F are shipped. The [M4 parent](m4-offers-and-pricing.md), [ADR 0014](../adr/0014-client-offers-publication-and-supply-compatibility.md), and [M4.0](m40-task-flow-and-contract.md) are accepted; [M4A](m4a-service-definitions-and-sources.md) and [M4B](m4b-client-pricing-and-anonymous-preview.md) are shipped. [M4C](m4c-packages-choices-and-client-terms.md) is shipped. [M4D](m4d-publication-and-live-feasibility.md) is Accepted and not shipped. M4E remains unimplemented.
...
**Amendment 2026-09-18 (M3E):** [M3E](m3e-supplier-operational-control.md) and [ADR 0013](../adr/0013-supplier-operational-commitments-deadlines-exposure-and-ending.md) are Accepted. M3E owns source-shaped commitment openings (`confirmation_trigger`, `deposit_requirement` tranche, `deadline_requirement`), append-only dispositions including `released`, Deposit Requirements, Deadlines, Staff planning milestones, qualified exposure, Needs attention, and normal Arrangement ending. There is no unrestricted manual commitment opening. Ordinary Supplier inactivation blocks only commitments whose current event-derived state is open; terminal dispositions cease blocking. [ADR 0012](../adr/0012-arrangement-activation-reservations-and-confirmations.md) retains its historical decision body with a dated supersession note for opening and inactivation wording.
...
| **[M3D.9 — Reservation integrity](m3d9-reservation-integrity.md)** | Post-ship remediation: confirmed quantity-basis fidelity through commitment opening, successor revision/request revalidation of scopes and booking Suppliers, Capacity Pool definition membership at insert, and event↔outcome compatibility in Rails and PostgreSQL. Shipped. |
| **[M3E — Supplier operational control](m3e-supplier-operational-control.md)** | Complete Supplier Commitment workflow beyond M3D's confirmation-triggered opening core; source-shaped openings (`confirmation_trigger`, `deposit_requirement` tranche, `deadline_requirement`) with no unrestricted manual opening; append-only dispositions including `released`, satisfaction, waiver, cancellation, and supersession; open-state ordinary inactivation blockers; Deposit Requirements without payable/payment state; Deadline definitions and occurrences; Staff planning milestones; qualified exposure; Needs attention; and normal Arrangement ending through enumerated safe cascades. Shipped through M3E.7b (including M3E.5R and M3D remediations). |
| **M3F — Acceptance and hardening** | Shipped. Contract: [m3f-acceptance-and-hardening.md](m3f-acceptance-and-hardening.md). Closure: [m3f4-milestone-closure.md](m3f4-milestone-closure.md). Integrated Celebrity/Vineyard proof, task-flow backlog, hardening, and milestone documentation. |
...
This parent is Accepted and amended for M3B, M3C, M3D (including shipped M3D.0), and M3E. Accepting or amending it is a documentation status change, not implementation authority for every M3 slice.

After M3D planning promotion (2026-09-17) and M3E Accept (2026-09-18):
...
* [M3E](m3e-supplier-operational-control.md) and [ADR 0013](../adr/0013-supplier-operational-commitments-deadlines-exposure-and-ending.md) are shipped through M3E.7b (including M3E.5R and M3D remediations). Arrangement ending is shipped. M3E is fully shipped.
* [M3F](m3f-acceptance-and-hardening.md) through [M3F.4](m3f4-milestone-closure.md) is shipped. Parent exit criteria 1–15 are mapped. **M3 is complete.** The [M4 parent](m4-offers-and-pricing.md), [ADR 0014](../adr/0014-client-offers-publication-and-supply-compatibility.md), and [M4.0](m40-task-flow-and-contract.md) are accepted; [M4A](m4a-service-definitions-and-sources.md) and [M4B](m4b-client-pricing-and-anonymous-preview.md) are shipped. [M4C](m4c-packages-choices-and-client-terms.md) is shipped. [M4D](m4d-publication-and-live-feasibility.md) is Accepted and not shipped. M4E remains unimplemented.
...
### M3F supplier-planning task-flow backlog

Owned by shipped [M3F](m3f-acceptance-and-hardening.md) (M3F.1 implemented these three items). M3F tested the complete M3A–M3E setup journey and addressed cross-slice friction discovered across those slices. **[M3E.7a](m3e-supplier-operational-control.md#m3e7a--operational-ui-recovery) owns defects in M3E’s own consequential forms and screens**; the items below were the M3F task-flow list and are now shipped:

1. **Occupancy-preview double preload** — verify against the branch that shipped the newer Supplier cost occupancy preview before fixing redundant forecast/preload work on the review path.
2. **Capacity-consequence row focus/removal** — keyboard focus and removal behavior for capacity-consequence rows in planning workflows.
3. **Exclusive occupancy-profile editing** — ensure occupancy-profile edit surfaces do not allow competing concurrent editors or ambiguous multi-edit states.
