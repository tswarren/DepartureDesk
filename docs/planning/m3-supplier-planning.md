...
**Status:** Accepted 2026-09-16. Amended 2026-09-16. Amended again 2026-09-16 for M3B capacity. Amended 2026-09-17 for M3C cost terms. Amended 2026-09-17 for M3D authority and M3D.0. Amended 2026-09-18 for M3E authority. [M3A](m3a-draft-arrangement-structure.md), [M3B](m3b-supplier-capacity.md), [M3C](m3c-cost-terms-and-forecasts.md), [M3D.0](m3d0-planning-workspace-compression.md), and [M3D](m3d-activation-reservations-confirmations.md) are shipped. [ADR 0012](../adr/0012-arrangement-activation-reservations-and-confirmations.md) is implemented by shipped M3D. [M3E](m3e-supplier-operational-control.md) and [ADR 0013](../adr/0013-supplier-operational-commitments-deadlines-exposure-and-ending.md) are shipped through M3E.7b (including M3E.5R and M3D remediations). Arrangement ending is shipped. M3E is fully shipped. Later M3F remains unimplemented.
...
* [M3E](m3e-supplier-operational-control.md) and [ADR 0013](../adr/0013-supplier-operational-commitments-deadlines-exposure-and-ending.md) are shipped through M3E.7b (including M3E.5R and M3D remediations). Arrangement ending is shipped. M3E is fully shipped. M3F remains unimplemented.
...
M3F tests the complete M3A–M3E setup journey and addresses cross-slice friction discovered across those slices. **[M3E.7a](m3e-supplier-operational-control.md#m3e7a--operational-ui-recovery) owns defects in M3E’s own consequential forms and screens**; the items below remain on the M3F task-flow list:
