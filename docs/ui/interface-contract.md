...
* Sidebar groups: **Workspace** (Dashboard, Directory, Clients, Suppliers, Departures, disabled Travelers / Accounting) and **System** (Administration). Travel programs are a secondary destination from Departures. Do not add an empty Money group.
