...
| [`planning/m4-offers-and-pricing.md`](planning/m4-offers-and-pricing.md) | Accepted M4 parent. Not implementation authority for later slices. M4A–M4D shipped; M4D.0 Accepted (not shipped); M4E unimplemented. |
...
| [`planning/m4d0-narrow-group-departure-builder.md`](planning/m4d0-narrow-group-departure-builder.md) | Accepted M4D.0 narrow group departure builder (M4D.0a). Not shipped. Implementation authority for 0b–0e only. |
...
| [`planning/drafts/README.md`](planning/drafts/README.md) | Draft staging area. M3E promoted 2026-09-18. M4 parent, ADR 0014, and M4.0 promoted 2026-09-20. M4A–M4D promoted/shipped 2026-09-20/21. M4D.0 Accepted 2026-09-21. |
