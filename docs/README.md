...
| [`planning/m4d0-narrow-group-departure-builder.md`](planning/m4d0-narrow-group-departure-builder.md) | Shipped M4D.0 narrow group departure builder. M4E remains unimplemented. |
