...
| [`planning/m3e-supplier-operational-control.md`](planning/m3e-supplier-operational-control.md) | Accepted M3E Supplier operational-control slice. M3E.1 openings/dispositions/evidence/open-state inactivation and M3E.2 Deadline definitions/occurrences/projection catch-up shipped; later M3E.3–M3E.7 records remain unimplemented. |
