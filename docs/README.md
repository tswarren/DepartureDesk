...
| [`planning/m3-supplier-planning.md`](planning/m3-supplier-planning.md) | Accepted M3 parent, amended through M3D authority. M3A–M3D, M3D.0, M3D.7, M3D.8, and M3D.9 shipped. Not implementation authority for M3E–M3F. |
