...
| [`planning/m4-offers-and-pricing.md`](planning/m4-offers-and-pricing.md) | Accepted M4 parent. Not implementation authority for later slices. M4A–M4D.0 (+R) shipped; M4D.1 Slice 1 shipped; Slice 2A.1–2A.2R3, 2B-R, Slice 2B, 2B-UX, and 2B-UX-R shipped; Slice 2C shipped; Slice 2D Accepted and not shipped; Slice 3 Accepted and not shipped; later M4D.1 slices and M4E unimplemented. |
...
| [`planning/m4d1-departure-composition-workspace.md`](planning/m4d1-departure-composition-workspace.md) | Accepted M4D.1 Departure Composition Workspace. Slice 1 and Slice 2A.1–2A.2R3, 2B-R, Slice 2B, 2B-UX, 2B-UX-R, and Slice 2C shipped; Slice 2D Accepted and not shipped; Slice 3 Accepted and not shipped; later slices remain unauthorized until named. |
...
| [`planning/m4d1-slice2d-cruise-client-terms-and-scenario-review.md`](planning/m4d1-slice2d-cruise-client-terms-and-scenario-review.md) | Accepted M4D.1 Slice 2D Cruise Client terms and scenario review (Stops F–G). Not shipped. Implementation base `b35a4f6`. |
| [`planning/m4d1-slice3-hotel-transportation-activity-adapters.md`](planning/m4d1-slice3-hotel-transportation-activity-adapters.md) | Accepted M4D.1 Slice 3 Hotel, Transportation, Activity, and mixed-DMC adapters. Not shipped. Implementation base `dc272a3`. |
