...
| [`planning/m3-supplier-planning.md`](planning/m3-supplier-planning.md) | Accepted M3 parent, amended through M3E authority. M3A–M3D, M3D.0, M3D.7, M3D.8, and M3D.9 shipped. [M3E](planning/m3e-supplier-operational-control.md) Accepted; M3E.1–M3E.5 shipped; remaining M3E.5R, M3D remediations, then M3E.6a–M3E.7b. Not implementation authority for M3F. |
