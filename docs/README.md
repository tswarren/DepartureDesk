...
| [`planning/m3-supplier-planning.md`](planning/m3-supplier-planning.md) | Accepted M3 parent, amended 2026-09-16. M3A is shipped; later slices remain unimplemented. Not implementation authority for M3B–M3F. |
