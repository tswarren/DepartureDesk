...
| [`planning/m3-supplier-planning.md`](planning/m3-supplier-planning.md) | Accepted M3 parent, amended through M3E authority. M3A–M3D, M3D.0, M3D.7, M3D.8, and M3D.9 shipped. [M3E](planning/m3e-supplier-operational-control.md) Accepted; not yet implemented. Not implementation authority for M3F. |
...
| [`planning/m3e-supplier-operational-control.md`](planning/m3e-supplier-operational-control.md) | Accepted M3E Supplier operational-control slice. M3E.1 openings/dispositions/evidence/open-state inactivation, M3E.2 Deadline definitions/occurrences/projection catch-up, M3E.3 Deposit Requirements/planning milestones, M3E.4 qualified exposure, and M3E.5 Needs-attention catalog/Departure rollup shipped; later M3E.6–M3E.7 records remain unimplemented. |
