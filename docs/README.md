...
| [`planning/m4-offers-and-pricing.md`](planning/m4-offers-and-pricing.md) | Accepted M4 parent. Not implementation authority for later slices. M4A–M4D.0 (+R) shipped; M4D.1 Slice 1 shipped; Slice 2A.1–2A.2R3, 2B-R, Slice 2B, 2B-UX, and 2B-UX-R shipped; Slice 2C shipped; Slice 2D shipped (merge `dc272a3`, PR #154); Slice 3R accepted for the layer boundary and delivery order only. The next unauthorized boundary is the Hotel walkthrough. Hotel implementation remains prohibited until that walkthrough and a separate Slice 3A plan are accepted. Later M4D.1 slices and M4E remain unimplemented. |
...
| [`planning/m4d1-departure-composition-workspace.md`](planning/m4d1-departure-composition-workspace.md) | Accepted M4D.1 Departure Composition Workspace. Slice 1 and Slice 2A.1–2A.2R3, 2B-R, Slice 2B, 2B-UX, 2B-UX-R, and Slice 2C shipped; Slice 2D shipped (merge `dc272a3`, PR #154); Slice 3R accepted for the layer boundary and delivery order only. The next unauthorized boundary is the Hotel walkthrough, which does not authorize code. |
...
| [`planning/m4d1-slice2a2r2-cruise-rate-matrix-interaction.md`](planning/m4d1-slice2a2r2-cruise-rate-matrix-interaction.md) | Shipped M4D.1 Slice 2A.2R2 Cruise Supplier Rate Matrix Interaction (sole shipped interactive builder chrome authority). |
| [`planning/m4d1-slice2a2r3-cruise-rate-shape-detector-remediation.md`](planning/m4d1-slice2a2r3-cruise-rate-shape-detector-remediation.md) | Shipped M4D.1 Slice 2A.2R3 Cruise rate-shape detector remediation (sole detector remediation authority). |
| [`planning/m4d1-slice2b-cruise-deposits-deadlines-and-activation-safe-editing.md`](planning/m4d1-slice2b-cruise-deposits-deadlines-and-activation-safe-editing.md) | Shipped M4D.1 Slice 2B typed Cruise deposits, deadlines, and activation-safe editing (sole typed Stop D authority; 2B-A/2B-B/2B-C delivered). |
| [`planning/m4d1-slice2bux-deposits-deadlines-workspace-remediation.md`](planning/m4d1-slice2bux-deposits-deadlines-workspace-remediation.md) | Shipped M4D.1 Slice 2B-UX typed Cruise deposits-and-deadlines workspace remediation (task-flow; product merge `bba974c` / PR #151). |
| [`planning/m4d1-slice2buxr-contributor-replace-and-closure.md`](planning/m4d1-slice2buxr-contributor-replace-and-closure.md) | Shipped M4D.1 Slice 2B-UX-R contributor-replace collision fix and 2B-UX ship-closure pins. |
| [`planning/m4d1-slice2c-cruise-service-connection.md`](planning/m4d1-slice2c-cruise-service-connection.md) | Shipped M4D.1 Slice 2C Cruise service connection, cabin choices, and option rate keys (merge `b35a4f6` / PR #153). |
| [`planning/m4d1-slice2d-cruise-client-terms-and-scenario-review.md`](planning/m4d1-slice2d-cruise-client-terms-and-scenario-review.md) | Shipped M4D.1 Slice 2D Cruise Client terms and scenario review (Stops F–G; merge `dc272a3`, PR #154). |
| [`planning/m4d1-slice3r-non-cruise-adapter-boundary.md`](planning/m4d1-slice3r-non-cruise-adapter-boundary.md) | Accepted M4D.1 Slice 3R layer boundary and delivery order. Authorizes the Hotel walkthrough only. Hotel implementation remains prohibited until that walkthrough and a separate Slice 3A plan are accepted. |
| [`planning/m4d1-slice2br-cruise-deposit-semantics-amendment.md`](planning/m4d1-slice2br-cruise-deposit-semantics-amendment.md) | Shipped M4D.1 Slice 2B-R M3E capacity-sourced deposit quantities and source-aware cumulative targets. |
...
| [`planning/drafts/README.md`](planning/drafts/README.md) | Draft staging area. M3E promoted 2026-09-18. M4 parent, ADR 0014, and M4.0 promoted 2026-09-20. M4A–M4D.0 (+R) shipped 2026-09-20/21. M4D.1 Accepted 2026-09-21. M4D.1 Slice 1 and Slice 2A.1 shipped 2026-09-22. Slice 2A.2 shipped 2026-09-22. Slice 2A.2R shipped 2026-09-22. Slice 2A.2R2 shipped 2026-09-22. |
