...
| [`planning/m3e-supplier-operational-control.md`](planning/m3e-supplier-operational-control.md) | Accepted M3E Supplier operational-control slice. M3E.1 openings/dispositions/evidence/open-state inactivation shipped; later M3E.2–M3E.7 records remain unimplemented. |
