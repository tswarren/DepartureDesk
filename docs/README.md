...
| [`planning/m3-supplier-planning.md`](planning/m3-supplier-planning.md) | Accepted M3 parent, amended through M3D authority. M3A–M3C and M3D.0 shipped. M3D Implemented—remediation pending. Not implementation authority for M3E–M3F. |
...
| [`planning/m3b-supplier-capacity.md`](planning/m3b-supplier-capacity.md) | Shipped M3B Supplier capacity slice. Draft configuration and the capacity engine are shipped; Arrangement activation and Staff event UI are Implemented—remediation pending with M3D. |
| [`planning/m3c-cost-terms-and-forecasts.md`](planning/m3c-cost-terms-and-forecasts.md) | Shipped M3C Supplier cost terms and forecasts slice. Draft cost sources, definitions, components, assumptions, and derived forecasts are shipped; Arrangement activation and effective contracted terms are Implemented—remediation pending with M3D. |
...
| [`planning/m3d-activation-reservations-confirmations.md`](planning/m3d-activation-reservations-confirmations.md) | M3D Arrangement activation, Reservations, and confirmations slice. Implemented—remediation pending. |
