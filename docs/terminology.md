...
| Cruise Supplier rate schedule | Accepted [M4D.1 Slice 2A.2](planning/m4d1-slice2a2-cruise-supplier-rates-and-occupancy-totals.md) vocabulary (not yet shipped). Typed adapter over generic M3C for Stop point C: rate terms, dollar or percentage expected commission, ephemeral occupancy illustrations vs confirmed forecast profiles, pending vs omitted commission. |
