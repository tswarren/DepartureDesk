...
| Cruise deposits and deadlines workspace | Accepted [M4D.1 Slice 2B](planning/m4d1-slice2b-cruise-deposits-deadlines-and-activation-safe-editing.md) vocabulary (2B-A typed deadlines delivered; deposits/activation remain open). Typed Arrangement-level adapter over generic M3E Deadline and Deposit Requirement definitions for Stop point D; not a parallel payment or obligation model. |
