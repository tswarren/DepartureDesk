...
| Forecast readiness | Shipped M3C draft vocabulary. Explicit `forecast_ready` state on a cost definition after validation (and Staff attestation for contracted). Planning claim only; not effective contracted terms. Arrangement activation and effective contracted terms remain M3D. |
