...
| Typed Cruise sailing setup | Accepted [M4D.1 Slice 2A.1](planning/m4d1-slice2a1-cruise-sailing-and-cabin-inventory.md) vocabulary (unshipped). Adapter over generic M3 Arrangement/Item/Occurrence/Resource/Pool for Stop points A–B; not a Cruise domain model. |
