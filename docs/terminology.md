...
| Target timing text | Accepted [M4D.0](planning/m4d0-narrow-group-departure-builder.md) vocabulary (not shipped). Descriptive Departure month/season/candidate prose (`departures.target_timing_text`). Never operational timing. |
| Client timing text | Accepted [M4D.0](planning/m4d0-narrow-group-departure-builder.md) vocabulary (not shipped). Version-owned Client-facing component timing prose on a Service Offer definition. Never parsed into operational dates. |
| Undecided fulfillment | Accepted [M4D.0](planning/m4d0-narrow-group-departure-builder.md) vocabulary (not shipped). Draft-only Service Offer fulfillment basis with no Supplier binding. Publication must reject it. |
| Not yet assigned to a Package | Accepted [M4D.0](planning/m4d0-narrow-group-departure-builder.md) presentation for an editable unowned Service Offer draft. Not a persisted commercial-scope flag. |
| Group departure builder | Accepted [M4D.0](planning/m4d0-narrow-group-departure-builder.md) Staff workspace over shipped Departure, Service Offer, and Package drafts. Derived readiness and internal Client preview only; no publication redesign. |
| Internal Client preview | Accepted [M4D.0](planning/m4d0-narrow-group-departure-builder.md) Staff-only anonymous Package preview labeled not shared with Clients. Creates no PDF, public link, proposal, or sale. |
