...
| Cruise Supplier rate schedule | Shipped [M4D.1 Slice 2A.2](planning/m4d1-slice2a2-cruise-supplier-rates-and-occupancy-totals.md) vocabulary. Typed adapter over generic M3C for Stop point C: rate terms, dollar or percentage expected commission, ephemeral occupancy illustrations vs confirmed forecast profiles, pending vs omitted commission. |
