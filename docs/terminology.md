...
| Cruise Supplier rate matrix | Accepted [M4D.1 Slice 2A.2R](planning/m4d1-slice2a2r-cruise-supplier-rate-matrix.md) vocabulary (not yet shipped). Rate profiles × charge/credit rows over generic M3C; Every Traveler / Every Cabin; shared vs profile-specific percentage commission; legacy projection and confirmed conversion. |
