...
| Deposit requirement | Shipped M3E.3 vocabulary. Exact-version Deposit Requirement Definition with closed amount shapes (fixed, quantity×rate, percentage of costs, cumulative target), embedded due rules (including planning-milestone arms), coverage/cost links, and immutable materialized tranches with append-only adjustment components. One `deposit_requirement` commitment per tranche. It is not a Payment or Obligation. |
...
| Group departure builder | Shipped [M4D.0](planning/m4d0-narrow-group-departure-builder.md) Staff workspace over Departure, Service Offer, and Package drafts, with interim [M4D.0R](planning/m4d0r-builder-interface-remediation.md) presentation. Derived readiness and internal Client preview only; no publication redesign. Future composition chrome is Accepted [M4D.1](planning/m4d1-departure-composition-workspace.md). |
| Internal Client preview | Shipped [M4D.0](planning/m4d0-narrow-group-departure-builder.md) Staff-only anonymous Package preview labeled not shared with Clients. Creates no PDF, public link, proposal, or sale. |
| Departure Composition Workspace | Accepted [M4D.1](planning/m4d1-departure-composition-workspace.md) vocabulary (not shipped). Five persistent Departure areas for Staff composition; freely navigable; not a linear wizard. |
| Service Map | Accepted [M4D.1](planning/m4d1-departure-composition-workspace.md) vocabulary (not shipped). Presentation of draft Service Offer identities as the Client-facing service outline; not a second commercial aggregate. |
| Preparation outcome | Accepted [M4D.1](planning/m4d1-departure-composition-workspace.md) presentation vocabulary (not shipped). Staff-facing outcome framing for recommended next work; not a persisted commercial state. |
| Enrollment assumption | Accepted [M4D.1](planning/m4d1-departure-composition-workspace.md) vocabulary (not shipped). Planning quantity for scenario economics distinct from travel configuration (occupancy/cabin facts). |
