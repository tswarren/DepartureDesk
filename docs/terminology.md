...
| Commitment | Shipped M3D opening vocabulary for confirmation-triggered openings only; full manual opening and disposition remain M3E. Explicit contractual exposure that may precede a Supplier Obligation. It is not an Obligation, invoice, or Payment. |
