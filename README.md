...
The shipped domain is agency identity plus the complete M1 Client and Supplier directories: an agency workspace, agency users, invitations, sessions, offices as context, administrator maintenance of the profile, offices, and users, Client Person, Client Organization, person-backed and organization-backed Client, person-owned and organization-owned contact points including organization websites, effective-dated organization contacts, Supplier with fixed categories and Supplier-owned contact points including websites, Supplier Locations, Supplier Contacts, and Supplier Contact-owned email and phone destinations. M1E shipped directory proof and hardening without a new domain aggregate. M2 is complete: dated Departures, activation, `D-` issuance, search, departed transitions, scheduled departed jobs, schedule/currency/lifecycle corrections, and M2C proof and hardening. Travel Program remains deferred. [M3A](docs/planning/m3a-draft-arrangement-structure.md) ships draft Supplier Arrangement structure under Departures. [M3B](docs/planning/m3b-supplier-capacity.md) ships draft Item capacity configuration and the capacity event/projection/reconciliation engine without Arrangement activation or Staff event UI. The [M3 parent](docs/planning/m3-supplier-planning.md) is accepted and amended for M3B and is not implementation authority for later slices. Arrangement activation, user-accessible effective capacity controls, costs, Reservations, commitments, Deadlines, exposure, and later M3 records remain unimplemented until an accepted slice names that work. [`docs/README.md`](docs/README.md) maps documentation authority; product authority is [`docs/planning/departure-desk-mvp.md`](docs/planning/departure-desk-mvp.md) and [`docs/planning/commercial-domain-decision-register.md`](docs/planning/commercial-domain-decision-register.md). Posted money objects are not implemented. [`docs/terminology.md`](docs/terminology.md) defines current vocabulary. PostgreSQL, Solid Queue, Docker development, UUIDv7 support, `money-rails`, and the application theme are present.

Architecture decisions are indexed in [`docs/adr`](docs/adr/README.md). [ADR 0001](docs/adr/0001-money-and-currency.md) accepts `money-rails`; the shipped application has no money records. [ADR 0005](docs/adr/0005-agency-identity.md) is the tenancy contract. [ADR 0006](docs/adr/0006-separate-identity-domains.md) governs the separation of planned identity domains. [ADR 0007](docs/adr/0007-departure-operational-root.md) accepts Departure as the dated operational root. [ADR 0008](docs/adr/0008-supplier-arrangement-version-topology.md) and [ADR 0009](docs/adr/0009-supplier-contracting-and-service-provider-roles.md) accept Arrangement topology and Supplier-role meanings; M3A draft topology and role behavior are implemented. [ADR 0010](docs/adr/0010-supplier-capacity-ledger-and-projection.md) accepts the capacity ledger; [M3B](docs/planning/m3b-supplier-capacity.md) shipped the implementing slice. Arrangement activation and later commercial records remain later-slice work. [ADR 0002](docs/adr/0002-agency-tenancy-and-membership.md) and [ADR 0003](docs/adr/0003-membership-lifecycle-and-invitations.md) are superseded by ADR 0005.
