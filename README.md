...
The shipped domain is agency identity plus the complete M1 Client and Supplier directories: an agency workspace, agency users, invitations, sessions, offices as context, administrator maintenance of the profile, offices, and users, Client Person, Client Organization, person-backed and organization-backed Client, person-owned and organization-owned contact points including organization websites, effective-dated organization contacts, Supplier with fixed categories and Supplier-owned contact points including websites, Supplier Locations, Supplier Contacts, and Supplier Contact-owned email and phone destinations. M1E shipped directory proof and hardening without a new domain aggregate. M2A and M2B ship dated Departures, activation, `D-` issuance, search, departed transitions, scheduled departed jobs, and schedule/currency/lifecycle corrections. This branch implements M2C proof and hardening; do not treat M2 as complete until that slice is merged. [`docs/README.md`](docs/README.md) maps documentation authority; product authority is [`docs/planning/departure-desk-mvp.md`](docs/planning/departure-desk-mvp.md) and [`docs/planning/commercial-domain-decision-register.md`](docs/planning/commercial-domain-decision-register.md). Posted money objects are not implemented. [`docs/terminology.md`](docs/terminology.md) defines current vocabulary. PostgreSQL, Solid Queue, Docker development, UUIDv7 support, `money-rails`, and the application theme are present.

Architecture decisions are indexed in [`docs/adr`](docs/adr/README.md). [ADR 0001](docs/adr/0001-money-and-currency.md) accepts `money-rails`; the shipped application has no money records. [ADR 0005](docs/adr/0005-agency-identity.md) is the tenancy contract. [ADR 0006](docs/adr/0006-separate-identity-domains.md) governs the separation of planned identity domains. [ADR 0002](docs/adr/0002-agency-tenancy-and-membership.md) and [ADR 0003](docs/adr/0003-membership-lifecycle-and-invitations.md) are superseded by ADR 0005.
